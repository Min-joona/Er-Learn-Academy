      ...
      <div className="mx-auto max-w-7xl px-5">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-foreground/50 mt-1">Manage your courses and students.</p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            { label: 'Pending Reviews', value: '—', icon: '📋', color: 'text-foreground' },
          ].map((s) => (
        ...
        {/* Course List */}
        <h2 className="text-xl font-display font-bold text-foreground mb-4">Your Courses</h2>
        {loading ? (
          ...
          <div className="card text-center py-12">
            ...
            <p className="text-foreground/50">No courses yet.</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {courses.map((c) => (
              <div key={c.slug} className="card-hover p-5">
                ...
                <p className="text-xs text-foreground/40 mt-1 line-clamp-2">{c.description}</p>
