    ...
    <div className="min-h-screen flex items-center justify-center px-5 pt-20">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-display font-bold text-[#CFC89A]">Welcome back</h1>
          <p className="text-[#CFC89A]/50 mt-1">Continue your learning journey.</p>
        </div>

        <form onSubmit={submit} className="card p-6 md:p-8 space-y-5">
          <div>
            <label className="block text-sm font-medium text-[#CFC89A]/70 mb-1.5">Email</label>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="text-sm font-medium text-[#CFC89A]/70">Password</label>
              <button type="button" className="text-xs text-amber/60 hover:text-amber transition-colors">Forgot password?</button>
            </div>
          ...
          <div className="text-center">
            <p className="text-sm text-[#CFC89A]/40">
