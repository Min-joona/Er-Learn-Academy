    ...
    <div className="pt-24 pb-16">
      <div className="mx-auto max-w-5xl px-5">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-display font-bold text-[#CFC89A]">Typing Drills</h1>
        ...
        {drills.length === 0 ? (
          <div className="card p-12 text-center text-[#CFC89A]/30">No typing drills yet.</div>
        ) : (
              ...
              <div key={d._id} className="card p-4 flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#CFC89A] font-medium truncate">{d.title}</span>
                    <span className="text-xs text-[#CFC89A]/30">{d.text?.length || 0} chars</span>
                  </div>
                  <p className="text-[#CFC89A]/40 text-xs truncate mt-0.5">{d.text?.slice(0, 80)}...</p>
                </div>
